...
extension CIImage {
    ...
    static var ciGPUContext = CIContext(eaglContext: sharedImageProcessingContext.context, options: [.outputPremultiplied: NSNumber(booleanLiteral: false), .workingFormat: CIFormat.RGBA8])
    static var ciCPUContext = CIContext(options: [.outputPremultiplied: NSNumber(booleanLiteral: false)])
    ...
    public var trimmedExtent: CGRect {
        let accurateExtent = self.accurateExtent
