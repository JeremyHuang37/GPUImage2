...
//        listName: "Test Sticker",
//        titleName: "sticker overlay",
//        sliderConfiguration: .disabled,
//        sliderUpdateCallback: nil,
//        filterOperationType: .custom(filterSetupFunction: {camera, filter, outputView in
//            let imageOverlay = filter as! ImageOverlayFilter
//            sharedImageProcessingContext.runOperationAsynchronously {
//                do {
//                    let imageURL = Bundle.main.url(forResource: "sticker", withExtension: "png")!
//                    let trackingInfo = ImageTrackingInfo(trackingPointStart: Position(0.69318366, -0.5778748), trackingPointCenter: Position(0.34032577, -0.42855394), trackingPointEnd: Position(-0.13876069, -0.71439624), rollDegree: -190, yawDegree: -15.273748, pitchDegree: -6.8050675)
//                    _ = try imageOverlay.addImage(id: "Sticker_1", imageURL: imageURL, offset: Position(0.0, -1.1834), scale: 1.3453, trackingInfo: trackingInfo)
//                    
////                    let item2 = try imageOverlay.addImage(id: "Sticker_2", imageURL: imageURL, trackingInfo: ImageTrackingInfo())
////                    item2.trackingInfo?.trackingPointStart = Position(0.69318366, -0.5778748)
////                    item2.trackingInfo?.trackingPointCenter = Position(0.34032577, -0.42855394)
////                    item2.trackingInfo?.trackingPointEnd = Position(-0.13876069, -0.71439624)
////                    item2.trackingInfo?.scale = 1.3453
////                    item2.trackingInfo?.rollDegree = -170
////                    item2.trackingInfo?.yawDegree = -15.273748
////                    item2.trackingInfo?.pitchDegree = -6.8050675
////                    item2.trackingInfo?.offset = Position(0.0, -1.1834)
//                } catch {
//                    print("failed to add image")
//                }
//            }
//            camera --> imageOverlay --> outputView
//            return imageOverlay
//        })
//    ),
    FilterOperation(
